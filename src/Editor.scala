...
class Editor {
    ...
    /** Transpose the characters and move one position*/
    def transpose = ed.transpose
    def setMark = ed.setMark
    def swapMark = ed.swapMark
    def copyText = ed.copy
    def cutText = ed.cut
    def pasteText = ed.paste
...
object Editor {
    ...
    val keymap = Keymap[Command](
        ...
        Display.HOME -> (_.moveCommand(HOME)),//HOME
        Display.END -> (_.moveCommand(END)),//END
        ...
        Display.CTRLHOME -> (_.moveCommand(CTRLHOME)),//CTRLHOME
        Display.CTRLEND -> (_.moveCommand(CTRLEND)),//CTRLEND
        Display.ctrl('T') -> (_.transpose),
        Display.ctrl('M') -> (_.setMark),
        Display.ctrl('O') -> (_.swapMark),
        Display.ctrl('C') -> (_.copyText),
        Display.ctrl('X') -> (_.cutText),
        Display.ctrl('V') -> (_.pasteText)
